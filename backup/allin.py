...
abc = st.sidebar.radio(                                   # DETERMINAR EL PARTIDO A GRAFICAR
...
#TITULO
st.header('Base de Datos elección presidencial 2021 - Segunda vuelta')
st.write("source : https://www.datosabiertos.gob.pe/dataset/resultados-por-mesa-de-las-elecciones-presidenciales-2021-segunda-vuelta-oficina-nacional-de")
